...
class ProjectMigrator extends migrator_1.Migrator {
    ...
    validate() {
        ...
        if (unsupportedBuilders.length) {
            errors.push({
                ...
                hint: `The supported builders for ${this.projectConfig.projectType === 'library'
                    ? 'libraries'
                    : 'applications'} are: ${(0, utilities_1.arrayToString)(allSupportedBuilders)}.`,
            });
        }
        ...
        targetTypes.forEach((targetType) => {
            ...
            errors.push({
                message: `There is more than one target using a builder that is used to ${targetType} the project (${(0, utilities_1.arrayToString)(targetsByType[targetType])}).`,
